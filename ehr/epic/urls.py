    ...
    "Administration": {
        ...
        "PractitionerRole": {
            ...
            "search_practitioner_role": {
                ...
                "method": "GET",
                "path": "/api/FHIR/R4/PractitionerRole?email={email}&identifier={identifier}&location=\
                    {location}&phone={phone}&practitioner={practitioner}&specialty={specialty}&organization=\
                        {organization}&role={role}&telecom={telecom}&_id={_id}",
            },
        },
        "Organization": {
        ...
        "Encounter": {
            ...
            "search_encounter": {
                ...
                "method": "GET",
                "path": "/api/FHIR/R4/Encounter?class={class}&date={date}&identifier={identifier}\
                    &onlyscannable={onlyscannable}&patient={patient}&subject={subject}&_count={_count}\
                        &_id={_id}",
            },
        },
        "Appointment": {
    ...
    "Clinic": {
        ...
        "Condition": {
            ...
            "search_problems": {
                ...
                "method": "GET",
                "path": "/api/FHIR/R4/Condition?subject={subject}&patient={patient}&clinical-status=\
                    {clinical-status}&category={category}",
            },
        ...
        "Procedure": {
            ...
            "search_procedure": {
                "category": "Procedure",
                "description": "Procedure.Search (R4)",
                "method": "GET",
    ...
    "Diagnostic": {
        ...
        "DiagnosticReport": {
            ...
            "search_results": {
                ...
                "method": "GET",
                "path": "/api/FHIR/R4/DiagnosticReport",
            },
        },
        "ServiceRequest": {
            "get_specific_community_resource": {
            ...
            "search_orders": {
                ...
                "method": "GET",
                "path": "/api/FHIR/R4/ServiceRequest",
            },
        },
        "BodyStructure": {
            "get_specific_tooth": {
    ...
    "Financial": {
        ...
        "ExplanationOfBenefit": {
            ...
            "search_explanation_of_benefit": {
                ...
                "method": "GET",
                "path": "/api/FHIR/R4/ExplanationOfBenefit?patient={patient}\
                    &created={created}",
            },
        },
    },
